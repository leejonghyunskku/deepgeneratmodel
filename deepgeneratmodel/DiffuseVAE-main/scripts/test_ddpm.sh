...
python /home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/main/eval/ddpm/sample_cond.py +dataset=/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/main/configs/dataset/cifar10/test \
                        +dataset.ddpm.data.norm=True \
                        ...
                        +dataset.ddpm.evaluation.device=\'gpu:0\' \
                        +dataset.ddpm.evaluation.save_mode='image' \
                        +dataset.ddpm.evaluation.chkpt_path=\'/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/final/result2/checkpoints/ddpmv2--epoch=999-loss=0.0261.ckpt\' \
                        ...
                        +dataset.ddpm.evaluation.save_path=\'/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/final2/\' \
                        +dataset.ddpm.evaluation.z_cond=False \
                        +dataset.ddpm.evaluation.n_samples=1000 \
                        +dataset.ddpm.evaluation.n_steps=1000 \
                        +dataset.ddpm.evaluation.save_vae=True \
                        +dataset.ddpm.evaluation.workers=1 \
                        +dataset.vae.evaluation.chkpt_path=\'/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/final/result/checkpoints/vae--epoch=999-train_loss=0.0000.ckpt\' \
                        +dataset.vae.evaluation.expde_model_path=\'/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/final2/\'
