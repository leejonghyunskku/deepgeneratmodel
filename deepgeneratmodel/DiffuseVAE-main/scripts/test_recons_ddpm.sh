...
python /home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/main/eval/ddpm/generate_recons.py +dataset=/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/main/configs/dataset/cifar10/test \
                        +dataset.ddpm.data.root='/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/cifar10/' \
                        +dataset.ddpm.data.name='cifar10' \
                        +dataset.ddpm.data.image_size=32 \
                        +dataset.ddpm.data.ddpm_latent_path="" \
                        ...
                        +dataset.ddpm.evaluation.device=\'gpu:0\' \
                        +dataset.ddpm.evaluation.save_mode='image' \
                        +dataset.ddpm.evaluation.chkpt_path=\'/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/final/result2/checkpoints/ddpmv2--epoch=74-loss=0.0000.ckpt\' \
                        ...
                        +dataset.ddpm.evaluation.save_vae=True \
                        +dataset.ddpm.evaluation.workers=1 \
                        +dataset.vae.evaluation.chkpt_path=\'/home/dsail/leejonghyun/deepgeneratmodel/DiffuseVAE-main/final/result/checkpoints/vae-epoch=74-train_loss=0.0000.ckpt\' \
