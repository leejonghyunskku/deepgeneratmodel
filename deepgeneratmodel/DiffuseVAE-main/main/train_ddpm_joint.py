...
def train(config):
    ...
    ddpm_wrapper = DDPMWrapper(
        ...
        vae_loss_weight= config.training.vae_loss_weight  # Added VAE loss weight
    )
    ...
    if device.startswith("gpu"):
        ...
        train_kwargs["plugins"] = None #DDPPlugin(find_unused_parameters=False)
