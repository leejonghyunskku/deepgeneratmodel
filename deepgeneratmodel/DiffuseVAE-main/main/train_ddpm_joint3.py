...
from models.diffusion import DDPM, DDPMv2, DDPMv3, DDPMWrapper3, SuperResModel, UNetModel
...
def train(config):
    ...
    ddpm_cls = DDPMv3 if ddpm_type == "form2" else DDPMv3
